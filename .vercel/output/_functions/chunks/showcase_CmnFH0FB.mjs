...
import { C as createComponent, _ as addAttribute, a as renderComponent, d as renderTemplate, h as maybeRenderHead } from "./server_WZyIJi8d.mjs";
...
var $$Showcase = createComponent(($$result, $$props, $$slots) => {
  ...
  <\/script>` })}`;
}, "C:/laragon/www/Chada/src/pages/showcase.astro", void 0);
var $$file = "C:/laragon/www/Chada/src/pages/showcase.astro";
var $$url = "/showcase";
//#endregion
