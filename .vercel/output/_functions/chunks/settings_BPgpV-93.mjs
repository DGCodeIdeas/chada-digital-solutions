...
var $$Settings = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		...
		"size": 16,
		"class": "size-4"
	})}Save Settings</button></div></form></main></div>${renderScript($$result, "C:/laragon/www/Chada/src/pages/admin/settings.astro?astro&type=script&index=0&lang.ts")}` })}`;
}, "C:/laragon/www/Chada/src/pages/admin/settings.astro", void 0);
var $$file = "C:/laragon/www/Chada/src/pages/admin/settings.astro";
