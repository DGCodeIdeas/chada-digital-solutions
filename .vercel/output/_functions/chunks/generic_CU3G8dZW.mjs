...
import { C as createComponent, S as createAstro, _ as addAttribute, b as unescapeHTML, d as renderTemplate, h as maybeRenderHead, t as spreadAttributes } from "./server_TAZ5Bv5Z.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_CeW-EqG1.mjs").catch((e) => {
