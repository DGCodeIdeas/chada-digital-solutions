...
var middlewareSecret = "5f77f731-077c-40b3-8dc0-5e7acda047c4";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/home/jules/.nvm/versions/node/v22.22.1/bin/node" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.chadadigital.com",
			"SSR": true
		}, { _: "/home/jules/.nvm/versions/node/v22.22.1/bin/node" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
