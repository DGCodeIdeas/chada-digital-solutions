...
import chadaLogo from "@/assets/chada-logo-horizontal.png";
import chadaMark from "@/assets/chada-mark.png";
...
function Logo({ className = "h-10" }: { className?: string }) {
  return (
    <a href="#hero" className="inline-flex items-center">
      <img src={chadaLogo} alt="Chada Digital — Digital Solutions That Scale Businesses" className={`${className} w-auto object-contain`} />
    </a>
  );
}
  ...
  return (
    <footer className="border-t border-border/40 bg-card/30 px-6 pt-16 pb-8">
      ...
      <div className="mx-auto mt-12 flex max-w-7xl items-center justify-between border-t border-border/40 pt-6">
        ...
        <img src={chadaMark} alt="" aria-hidden className="h-6 w-auto opacity-60" />
      </div>
    </footer>
  );
}
